...
|08.|--|--|--|
|09.|--|--|--|
|10.|[Защита персональных данных клиентов](https://github.com/DEli-26/DS_Practicum/tree/main/10_matrix)|Аналитически решается задача выбора оптимального метода шифрования данных. Предложенный подход проверен при попощи линейной регрессии.|numpy, pandas, matplotlib, LinearRegression|
